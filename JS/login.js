...
function openLogin() {
    ...
    ' <!--Password--> ' +
        ...
        ' <h2 onclick="login()" style="border-color: #424242; border-style: solid; height : 40px; background-color : #424242; border-radius : 10px; left: 25px; margin-top : 50px; color: #EFE2C2; font-size: 20px; font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: bold; word-wrap: break-word" center>Login</h2>' + 
        ...
        ' style=" position : absolute; margin-left : 5px; margin-bottom : 5px; text-align: center; color: black; font-size: 12px; font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: 400; text-decoration: underline; word-wrap: break-word">Registar conta</a></div>';
}
