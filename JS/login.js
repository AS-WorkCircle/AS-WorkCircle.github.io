...
function openLogin() {
    ...
    ' <input id="email" style="left: 25px; bottom : 75px; position: absolute; color: rgba(0, 0, 0, 0.50); font-size: 20px; font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: 400; word-wrap: break-word" placeholder="E-mail"> ' +    
    ' <!--Password--> ' +
        ' <input id= "passwordInput" style="left: 25px; position: absolute; color: rgba(0, 0, 0, 0.50); font-size: 20px; font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: 400; word-wrap: break-word" placeholder="Password"> '+
